...
education: {
    ...
    right: {
      book: [
        { img: 'Assets/Education-1.png', title: 'Training Videos', subtitle: 'Coffee Training Videos' },
        { img: 'Assets/Education-2.png', title: 'Training & Support', subtitle: 'Award winning training and support' }
      ]
    }
  }
};
...
const products = {
  ...
  all: [
    { img: "Assets/Product-coffee-1.png", name: "Panama Coffee", desc: "Introducing El Vergel Estate, a vibrant new coffee from the Bayter family’s innovative farm in Fresno, Tolima. This Red and Yellow Caturra variety.", price: "£15.50" },
    { img: "Assets/capsule-image 1.png", name: "House Espresso Capsule", desc: "Introducing El Vergel Estate, a vibrant new coffee from the Bayter family’s innovative farm in Fresno, Tolima. This Red and Yellow Caturra variety.", price: "£16.90" }
  ]
};
